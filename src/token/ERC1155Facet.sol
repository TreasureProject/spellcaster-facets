...
abstract contract ERC1155Facet is FacetInitializable, SupportsMetaTx, ERC1155Upgradeable {
     ...
     */
    function setApprovalForAll(address operator, bool approved) public override virtual supportsMetaTxNoId {
     ...
     * @dev Adding support for meta transactions
     */
    function safeBatchTransferFrom(address from, address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data) public override virtual supportsMetaTxNoId {
     ...
     * @dev Adding support for meta transactions
     */
    function safeTransferFrom(address from, address to, uint256 id, uint256 amount, bytes memory data) public override virtual supportsMetaTxNoId {
